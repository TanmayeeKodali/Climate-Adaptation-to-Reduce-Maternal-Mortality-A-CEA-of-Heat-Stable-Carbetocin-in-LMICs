...
This dashboard operationalizes a **decision-analytic cost-effectiveness framework** to ask:
  ...
  1. **Visualization 1 – Choropleth: Projected Temperature Warming**
...
2. **Visualization 2 – Bubble Chart: Women at Risk of Inadequately Treated PPH**
...
3. **Visualization 3 – ICER Threshold-Crossing Year Map**
...
- **Cost-effectiveness model:**
  ...
  - Direct medical costs:Drug and delivery costs.
